...
def cal_distance(center_atom, second_atom, pos_new, pos_su):
    ...
    Args:
        center_atom: The position of center atom.
        second_atom: The position of second atom.
        pos_new: The position of atoms in the cell.
        pos_su:  The position of atoms in the supercell.

    Returns:
        distance: The distance between atoms.
    """
...
def cal_neighbors(ele, pos_new, ele_su, cutoff1, cutoff2, pos_su, skip_distance, ion):
    ...
    Args:
        ...
        pos_new: The position of atoms in the cell.
        ele_su: The elements of atoms in the supercell.
    ...
    Returns:
        neighbors: The neighbors distance of atoms in the 1st shell.
        neighbors_ele:  The neighbors element of atoms in the 1st shell.
        neighbors_2: The neighbors distance of atoms in the 2nd shell.
        neighbors_ele_2: The neighbors element of atoms in the 2nd shell.
    """
    neighbors = []
    neighbors_ele = []
    neighbors_2 = []
...
def plot_neighbors(cutoff, neighbors_1, neighbors_2):
    ...
    Args:
        cutoff: The maximum cutoff for the neighbor calculation.
        neighbors_1: The neighbors distance of atoms in the 1st shell.
        neighbors_2: The neighbors distance of atoms in the 2nd shell.

    Returns:
        save_plot_data: The plot data of neighbor calculation.
    """
...
def plot_partial_neighbors(cutoff, neighbors_1, neighbors_2, ele, neighbors_ele, neighbors_ele_2, ion1):
    ...
    Returns:
        save_plot_data: The plot data of partial neighbor calculation.
    """
